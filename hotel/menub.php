      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <p class="centered"><a href="profile.php"><img src="../_foto/3.jpg" class="img-circle" width="80"></a></p>
                    <h5 class="centered">Hello, <?php echo $_SESSION['username'] ?>!</h5>
                  <?php }else{ ?>
                    <p class="centered"><a href="home.php"><img src="../_foto/3.jpg" class="img-circle" width="80"></a></p>
                    <h5 class="centered">Hello, Visitor!</h5>
                  <?php } ?>

                  <li class="sub">
                      <a href="home.php" style="cursor:pointer;background:none"><i class="icon-home"></i>Home</a>
                  </li>

                  <li class="sub">
                      <a href="aboutHotelBukittinggi.php" style="cursor:pointer;background:none"><i class="fa fa-info-circle"></i>About Hotel in Bukittinggi</a>
                  </li>
<!-- list hotel -->
                  <li class="sub">
