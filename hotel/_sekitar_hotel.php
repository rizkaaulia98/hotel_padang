<?php
	...
	$querysearch = "SELECT id,name,ST_Y(ST_CENTROID(geom)) as lat, ST_X(ST_CENTROID(geom)) as lng
	from hotel a where st_intersects(st_centroid(a.geom), ST_buffer(ST_GeomFromText(concat('POINT($longi $latit)')), 0.0009*$rad))=1";
